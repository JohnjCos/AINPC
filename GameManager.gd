...
var api_key: String = "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"
...
func dialogue_request (player_dialogue):
	...
	if len(messages) == 0:
		...
		header_prompt += "You location is " + current_npc.location_description + "."
		header_prompt += "You have secret knowledge you will not speak about unless asked by me: " + current_npc.secret_knowledge + "."
